      ...
      <section className="bg-light py-4 py-md-5 py-xl-8 border-top border-light">
        <div className="container overflow-hidden">
          <div className="row gy-4 gy-lg-0 justify-content-xl-between">
            ...
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
              <div className="widget">
                ...
                <address className="mb-4">
                  Via dei libri mai aperti 4, suonare "Ciccio"
                </address>
                <p className="mb-1">
                  <a
            ...
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
              <div className="widget">
                <h4 className="widget-title mb-4">Scopri di più</h4>
            ...
            <div className="col-12 col-lg-3 col-xl-4">
              <div className="widget">
                <h4 className="widget-title mb-4">La newsletter</h4>
                <p className="mb-4">
                  Iscriviti per rimanere in contatto con Epibooks
                </p>
                <form action="#">
